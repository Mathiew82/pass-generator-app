...
pub const GENERATED_PASSWORD_PLACEHOLDER: &str = "Pulsa Generar contraseña para crear una nueva";
...
pub const SECURITY_FEEDBACK_HEADER: &str = "Seguridad de la contraseña";
